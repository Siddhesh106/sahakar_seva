        ...
        {submitted ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="border-2 border-dashed border-slate-200 hover:border-emerald-500 rounded-2xl p-8 text-center bg-slate-50/50 hover:bg-slate-50 transition cursor-pointer">
                <Upload className="w-9 h-9 text-slate-400 mx-auto mb-2" />
                <p className="text-xs font-medium text-slate-700">Click to upload document file or photo</p>
